...
//     // Add to subscribed products (local state)
//     subscribedProductIds.add(purchase.productID);

//     // ✅ First, check with backend if user already has an active subscription.
//     //    If yes, avoid calling verify API again to prevent
//     //    "Invalid or Expired Subscription Receipt" errors and just
//     //    mark the user as subscribed in the app.
//     final latestProfile =
//         await profileController.profileRepository.getProfile();
//     final bool alreadySubscribed = latestProfile?.isSubscribed == true;

//     if (alreadySubscribed) {
//       appLog(
//         "✅ User already has active subscription on backend. "
//         "Skipping verify API and marking as subscribed locally.",
//         source: "Verify Purchase",
//       );
...
//     // If backend does NOT report an active subscription, call verify API
//     // so server can validate this new purchase/restore.
//     appLog(
